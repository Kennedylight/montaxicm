...
<style>
  ...
  <!-- users/index.php – Gestion des Conducteurs (simulation front avec cards et modal) -->
  ...
  <div class="users-page">
    ...
    <div class="modal" id="user-modal" style="display: none;">
      <div class="modal-content">
        ...
        <h2>Détails conducteur</h2>
        <div class="modal-body" id="modal-body"></div>
        <div class="modal-actions">
          <a href="#" class="btn-block"><i class="fas fa-ban"></i> Bloquer</a>
          <a href="#" class="btn-suspend"><i class="fas fa-ban"></i> Suspendre</a>
          <a href="#" class="btn-delete"><i class="fas fa-trash"></i> Supprimer</a>
        </div>
      </div>
    </div>
  </div>
